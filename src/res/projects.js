...
const projects = {
  ...
  theia: {
    ...
    description: {
      ...
      cn: 
        "**轻巧型图像加载程序** 适用于带有高速缓存系统以及**Kotlin DSL**的安卓系统",
　　　 jp:
        "キャッシュシステムと**Kotlin DSL**で作られたAndroid用の**軽量イメージローダ**",
  ...
  viewStateStore: {
    ...
    description: {
      ...
      jp: 
        "LiveDataを包装し、la UIへの単方向データフローを処理することが許可される。
  ...
  materialBottomBar: {
    ...
    description: {
      ...
      jp:
        "カスタマイズされた_BottomAppBar_を実現して、少々簡単なステップで、**bottom drawer**を完成できます。
    },
